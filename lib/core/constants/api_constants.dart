class ApiConstants {
  static const String baseUrl = 'http://192.168.1.1:3000/api';
  ...
  static const String deleteImage = '$baseUrl/delete-image';
  ...
  static const String changeStatusTour = '$baseUrl/change-status-tour';
