              ...
              children: [
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                      ConstrainedBox(constraints: const BoxConstraints(maxHeight: 120), child: const Center(child: LogoWidget())),
                      ConstrainedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            const LoginTab(),
                            ClipRRect(borderRadius: BorderRadius.circular(25), child: Image.asset('assets/images/image_auth.png', height: 569)),
                          ],
                        ),
                      ),
                      SizedBox(
                ...
                Container(color: Colors.amber, child: SizedBox(height: 100.h)),
              ],
            ),
          ),
        ),
